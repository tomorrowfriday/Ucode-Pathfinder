...
int main(int argc, const char **file) 
{
    ...
    stringsoffile = pf_stringtoarr(char *data, char *stringsoffile[], int sizeoffile, int numbersofstrings);
    // int sortoffile = 0;
    // int strlen = 0;
    ...
    for(int x = 0; x < numbersofstrings; x++)
    {
    // printf("%s", pf_stringtoarr(data, sizeoffile, numbersofstrings)[0]);
